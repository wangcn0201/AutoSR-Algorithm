...
class GraphModel_EdgeWeight(torch.nn.Module):
	def __init__(self, edge_num, Parameters, Options, Relations, embedding_dim=32, output_dim=16, hidden_dim=8, K=10, alpha=0.1, dropout=0.5):
		super(GraphModel_EdgeWeight, self).__init__()
		self.edgeweight = nn.Parameter(torch.FloatTensor(edge_num))
